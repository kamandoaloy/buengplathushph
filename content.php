      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="swiper init-swiper">
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide" style="background-image: url('assets/img/post-slide-01.jpg');">
              <div class="content">
                <h2><a href="single-post.html">รณรงค์ฉีดวัคซีนไข้หวัดใหญ่ตามฤดูกาลในกลุ่มเสี่ยงสูง</a></h2>
                <p>โรงพยาบาลส่งเสริมสุขภาพตำบลบ้านบึงปลาทู ร่วมกับชมรมอาสาสมัครสาธารณสุขประจำหมู่บ้าน (อสม.) ตำบลบึงปลา จะดำเนินกิจกรรมรณรงค์ฉีดวัคซีนไข้หวัดใหญ่ตามฤดูกาลในกลุ่มเสี่ยง ในวันที่ 26 พฤษภาคม 2568 ณ โรงพยาบาลส่งเสริมสุขภาพตำบลบ้านบึงปลาทู</p>
              </div>
            </div>

            <div class="swiper-slide" style="background-image: url('assets/img/hospital-01.jpg');">
              <div class="content">
                <h2><a href="single-post.html">โรงพยาบาลส่งเสริมสุขภาพตำบลบ้านบึงปลาทู</a></h2>
                <p>ตั้งอยู่ที่หมู่ 3 ตำบลบึงปลาทู อยู่ทางทิศเหนือของอำเภอบรรพตพิสัย ห่างจากจังหวัดนครสวรรค์ ประมาณ 45 กิโลเมตร </p>
              </div>
            </div>
          ...
          <div class="row g-5">
            <div class="col-lg-4">
              ...
              <div class="post-entry lg">
                <a href="blog-details.html"><img src="assets/img/healthy.png" alt="" class="img-fluid"></a>
                <div class="post-meta"><span class="date">Identity</span> <span class="mx-1">•</span> <span>May 26th '25</span></div>
                <h2><a href="blog-details.html">อัตลักษณ์</a></h2>
                <p class="mb-4 d-block">ความหมาย
                    <ol>
                      <li>ดาว 6 ดวงในวงกลมสี หมายถึง องค์กรในชุมชนขับเคลื่อนด้านสุขภาพ ได้แก่ รพ.สต., อสม., วัด, โรงเรียน, ชุมชน และ อบต.</li>
                      <li>เชือกวงกลมผสานผ่านดวงดาว หมายถึง ความประสานร่วมมือขององค์กรในชุมชน</li>
                      <li>HEALTHY หมายถึง สุขภาพดี</li>
                      <li>รูปคน 5 คน หมายถึง 5 กลุ่มวัย</li>
                      <li>ปลาทู 2 ตัวในบึง หมายถึง ตำบลบึงปลาทู</li>                        
                    </ol>                   
                  </p>

                <div class="d-flex align-items-center author">
                  <div class="photo"><img src="assets/img/logo-shph.png" alt="" class="img-fluid"></div>
                  <div class="name">
            ...
            <div class="col-lg-8">
              <div class="row g-5">
                ...
                <div class="col-lg-4 border-start custom-border">
                  <div class="post-entry">
                    <a href="blog-details.html"><img src="assets/img/post-landscape-03.jpg" alt="" class="img-fluid"></a>
